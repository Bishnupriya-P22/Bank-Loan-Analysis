...
Analyze borrower income and employment patterns
Evaluate credit grades and risk levels
Understand interest rate distribution
Assess repayment performance and portfolio health
...
Standardized categorical variables (Grade, Term, Home Ownership)
...
Loan performance evaluation using total payment analysis
...
Home Ownership: RENT and MORTGAGE borrowers dominate loan applications
Loan Amount Distribution: Most loans range between $5,000 – $15,000, focusing on small-to-mid ticket loans

##Loan Term Preference:
36 Months: 28,237 loans
60 Months: 10,339 loans
...
Majority of loans are short-term, reducing long-term default risk
Healthy debt-to-income levels indicate good borrower affordability
Interest rates are well-aligned with credit risk levels
...
Aspiring **Data Analyst** | Skilled in **Python, SQL, Power BI, Excel, and Data Visualization**  
 ...
 Connect with me on :[Bishnupriya Pattnaik](https://www.linkedin.com/in/bishnupriya-pattnaik)  
